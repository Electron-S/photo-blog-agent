...
// 네이버는 10~19 블록을 쓴다. 조치가 다르면 코드도 다르다.
...
const NAVER_EXIT = {
  ...
  SELECTOR: 12,
  // --- 아래 셋은 예약된 코드다. 발행 레이어(lib/naver-editor.js)가 구현되기
  // 전까지는 어디서도 throw되지 않는다. 각 스크립트의 usage에 "(예약)"으로
  // 표시해, 문서만 보고 이미 동작한다고 오해하지 않게 한다. ---
  //
